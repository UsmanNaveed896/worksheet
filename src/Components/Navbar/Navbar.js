                                ...
                                <div className="sidebar-options">
                                    <div className="signup-options">
                                        <ul>
                                            ...
                                            <Link to="/employees/" className="nav-link">   <li><i class="fa fa-users dropdown-icon" aria-hidden="true"></i>EMPLOYEES</li></Link>
                            ...
                            <div className="login-access d-flex justify-content-end mt-3 ">
                                ...
                                <div class="dropdown-user">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <li class="dropdown-item" onClick={() => logoutUser()}><i class="fa fa-power-off dropdown-icon" aria-hidden="true" ></i>Logout</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
