                ...
                <div className="page-title-main container">
                    <div className="head">
                        <div className="heading-title d-flex justify-content-between ">
                            <div className="mt-4"><h3>ADD JOB TITLE</h3></div>
                    ...
                    <div className="add-job col-md-12 d-flex justify-content-space-evenly">
                        <div className="add-title col-md-4 mt-5">
                            <form>
                        <label className=" mt-2" for="Text">Department</label>
                                <select class="selectpicker mt-2" title="Some placeholder text...">
                                    <option data-hidden="true">Select Department</option>
                                    <option>First</option>
                                    <option>Second</option>
                                </select>
                                <div class="form-group ">
                                    <label class="mt-3" for="exampleInputPassword1 ">Job Title</label>
                                    <input type="text" class="form-control mt-1" placeholder="Enter Job Title" />
                                </div>
